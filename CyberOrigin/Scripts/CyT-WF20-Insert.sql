...
VALUES(
	...
	'afaf3924-9ec8-4123-940e-f5ed33e989bd' --P&B  -- next
 	) RETURNING id;
/*------------------------------
...
SELECT id, registered, registered_response, registered_success
  FROM bl20_v1_st01_purchase WHERE id=2;
...
VALUES(
	...
	'afaf3924-9ec8-4123-940e-f5ed33e989bd',--P&B  -- stake
	'afaf3924-9ec8-4123-940e-f5ed33e989bd' --P&B  -- next
) RETURNING id;
-- CONTROL --
SELECT id, registered, registered_response, registered_success
  FROM bl20_v1_st02_provider WHERE id=3;
...
VALUES(
	...
	'afaf3924-9ec8-4123-940e-f5ed33e989bd',--P&B  	-- stake
	'ba0c1b58-3f20-41bd-971e-934a7a09f7ea',--C4CUT  -- next
...
/*UPDATE bl20_v1_st04_parcel_assessment SET cert_rjc_member_certificate =
(SELECT cert_rjc_member_certificate FROM bl20_v1_st03_rough_purchase_pre WHERE id=8)
WHERE id=2;*/
...
-- CONTROL --
SELECT id, registered, registered_response, registered_success
  FROM bl20_v1_st04_parcel_assessment WHERE id=2;
...
(
	...
	'ba0c1b58-3f20-41bd-971e-934a7a09f7ea',--C4CUT  -- Stake
	'afaf3924-9ec8-4123-940e-f5ed33e989bd',--P&B    -- NEXT
...
/*
UPDATE bl20_v1_st05_cut 
    SET cert_rjc_member_certificate =
(SELECT cert_rjc_member_certificate FROM bl20_v1_st05_cut WHERE id=6)
WHERE id=8;*/
-- CONTROL --
SELECT id, registered, registered_response, registered_success
  FROM bl20_v1_st05_cut WHERE id=8;
...
/*
UPDATE bl20_v1_st06_quality_control 
    SET cert_rjc_member_certificate =
(SELECT cert_rjc_member_certificate FROM bl20_v1_st04_parcel_assessment WHERE id=2)
WHERE id=3;*/
...
insert into  bl20_v1_st06_quality_control_polisher_invoice_id(
 ...
 -- CONTROL --
SELECT id, registered, registered_response, registered_success
  FROM bl20_v1_st06_quality_control WHERE id=3;
...
(
 ...
 -- CONTROL --
SELECT id, registered, registered_response, registered_success
  FROM bl20_v1_st07_choose_lab WHERE id=2;
...
(
 ...
 -- CONTROL --
SELECT id, registered, registered_response, registered_success
  FROM bl20_v1_st08_lab_data WHERE id=4;
...
(
 ...
 -- CONTROL --
SELECT id, registered, registered_response, registered_success
  FROM bl20_v1_st09_quality_control_and_order_approval WHERE id=6;
