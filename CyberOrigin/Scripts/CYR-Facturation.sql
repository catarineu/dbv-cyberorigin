...
--	SELECT 50 AS vp0, 0.15 AS vp1, 0.04 AS vp2, 0.02 AS vp3, 
--		               300 AS  p1, 2000 AS p2, 
--		   50 AS vc0,   50 AS vc1,   15 AS vc2,    5 AS vc3,
--		                 1 AS  c1,   10 AS c2

SET lc_numeric = 'fr_CH.UTF-8';
...
--	   AND psi.cyber_id ~ 'CYR01-24-0022-297400'
	   AND (psi.group_record_type IS NULL OR psi.group_record_type <> 'GROUP_MOVEMENT') -- Descartem lots de grup
--	   AND psi.cyber_id IN ('CYR01-24-0121-330649', 'CYR01-24-0025-297405D337302', 'CYR01-23-0696-292862', 'CYR01-23-0682-292685')
), calc AS (
